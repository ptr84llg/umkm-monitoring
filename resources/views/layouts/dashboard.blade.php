            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'detail' => 'Analisis wilayah, sektor, tenaga kerja, akses pasar, legalitas, mutu data, dan keuangan sesuai kewenangan.',
    ...
    $dashboardSubmenuFor = function (array $menuItem) use ($dashboardRoleKey): array {
        ...
        $submenuMap = [
            ...
            'analitik' => [
                ...
                ['title' => 'Keuangan & Mutu Data', 'description' => 'Cakupan keuangan, sumber pinjaman, dan quality issue.', 'state' => 'Aktif'],
            ],
            'laporan' => [
