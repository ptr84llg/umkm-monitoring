...
@section('title', 'Klaim Akun Pelaku UMKM')
        ...
        <div class="card-body p-4">
            <div class="d-flex flex-column flex-lg-row justify-content-between gap-3">
                <div>
                    ...
                    <h1 class="h3 mb-2">Account Claim & Activation</h1>
                    <p class="text-body-secondary mb-0">
                        Review keterkaitan pemohon dengan UMKM. Approval tidak membuat ownership binding
                        dan tidak mengubah record sumber LSS.
                    </p>
                </div>
                ...
                <table class="table align-middle">
                    ...
                    @forelse ($claims as $claim)
                        <tr>
                            ...
                            <td>{{ $claim->claim_type === 'dinas_invite' ? 'Undangan Dinas' : 'Klaim Mandiri' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-body-secondary py-4">Belum ada klaim pada konteks ini.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
