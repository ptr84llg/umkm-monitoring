...
@section('title', 'Detail Klaim Akun Pelaku UMKM')
...
<div class="d-flex flex-column gap-4">
        ...
        <div class="card-body p-4">
            <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 mb-4">
                <div>
                    ...
                    <h1 class="h3 mb-1">Klaim {{ $claim->claim_reference }}</h1>
            ...
            <dl class="row mb-0">
                ...
                <dt class="col-md-3">Relasi</dt>
                <dd class="col-md-9">{{ $claim->relationship_type }}</dd>
                <dt class="col-md-3">Jenis Klaim</dt>
                <dd class="col-md-9">{{ $claim->claim_type }}</dd>
                <dt class="col-md-3">Review Dinas</dt>
                <dd class="col-md-9">{{ $claim->reviewedBy?->name ?? 'Belum direview' }}</dd>
    ...
    @if ($claim->status === 'pending_review')
        <section class="card border shadow-sm">
            <div class="card-body p-4">
                <h2 class="h5 mb-3">Review Klaim</h2>
                <form method="POST"
                    ...
                    <div>
                        ...
                        <div class="form-text">Catatan wajib diisi jika klaim ditolak.</div>
                    </div>
                    <div class="d-flex flex-wrap gap-2">
                        <button class="btn btn-success" type="submit" name="action" value="approve">Setujui dan Kirim Aktivasi</button>
                        <button class="btn btn-outline-danger" type="submit" name="action" value="reject">Tolak Klaim</button>
                    </div>
                </form>
            </div>
        </section>
        ...
        <section class="card border shadow-sm">
            <div class="card-body p-4">
                ...
                <p class="text-body-secondary">
                    Dinas hanya mengirim ulang challenge. Dinas tidak membuat password dan tidak membuat ownership binding.
                </p>
        ...
        <div class="card-body p-4">
            ...
            <div class="table-responsive">
                <table class="table align-middle">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center text-body-secondary">Belum ada event.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
