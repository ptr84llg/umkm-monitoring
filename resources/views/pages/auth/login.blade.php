...
<section class="auth-login-page" data-auth-login-page>
    ...
    <div class="container auth-container">
        <div class="auth-shell umkm-glass-strong">
                    ...
                    <div class="card auth-card">
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between gap-3 mb-3">
                                ...
                                <span class="badge auth-card-badge">Secure</span>
                            </div>
                            ...
                            <form method="POST" action="{{ route('login.store') }}" class="auth-form" data-auth-login-form novalidate>
                                ...
                                <button type="submit" class="btn btn-primary w-100 auth-submit" data-auth-submit disabled>
                                    <span class="auth-submit-text">Masuk ke Sistem</span>
                                </button>

                                <div class="auth-form-note mt-3">
