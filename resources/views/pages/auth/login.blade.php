            ...
            <div class="col-lg-6 col-xl-6">
                <div class="auth-hero-panel">
                    ...
                    <div class="auth-hero-content">
                        ...
                        <p>
                            Halaman ini digunakan untuk akses internal pengelolaan data, validasi, pemantauan indikator,
                            dan visual analitik UMKM sesuai kewenangan pengguna.
                        </p>
                    </div>
                    ...
                    <div class="auth-security-list" aria-label="Ringkasan keamanan login">
                        <div class="auth-security-item">
                            ...
                            <span>
                                ...
                                <small>CSRF, validasi server, audit, dan pembatasan akses tetap aktif.</small>
                            </span>
                        </div>
                        ...
                        <div class="auth-security-item">
                            ...
                            <span>
                                ...
                                <small>Akses login memerlukan pemeriksaan lokasi pada perangkat.</small>
                            </span>
                        </div>
                        ...
                        <div class="auth-security-item">
                            ...
                            <span>
                                ...
                                <small>Aktivitas login berhasil maupun gagal disiapkan untuk pencatatan audit.</small>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5 col-xl-4">
                <div class="auth-card" data-auth-card>
                    ...
                    <div class="auth-location-panel" data-auth-location-panel>
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary auth-location-button" data-auth-location-check>
                            Periksa Lokasi
                        </button>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login.store') }}" class="auth-form" data-auth-login-form novalidate>
                        ...
                        <button type="submit" class="btn btn-primary auth-submit" data-auth-submit disabled>
